...
The Sigma Device iOS SDK uses the following functions to collect device data and send it to Socure:
...
```
DeviceRiskManager.sharedInstance.sendData(context:String)
```
